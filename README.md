...
- **更新日期**: 2026年2月6日
- **更新日志**:
  - 新增比例预设节点，支持快速选择常用宽高比（1:1、2:3、3:2等）。新增分辨率预设节点，支持快速选择常用分辨率（1K、2K、4K、8K等）。
  - 添加比例预设节点(AspectRatioPresetSelector)和分辨率预设节点(ResolutionPresetSelector)，支持快速选择常用比例和分辨率
  - 重构尺寸预设节点(SizeSelector)的显示格式为'比例-名称：宽x高'
