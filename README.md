...
- **更新日期**: 2026年4月5日
- **更新日志**:
- 新增API节点模块，支持火山引擎豆包Seedream文生图、图生图和百炼LLM等功能
- 新增媒体处理节点：图片转视频、加载音频/视频路径、批量重命名视频等
- 新增实用工具节点：循环生成器、计数器、文件夹/文件列表、批量创建文件夹等
- 新增图像处理节点：图像网格拆分、批量图片合并、批量文件夹图片压缩
- 新增视频尺寸预设节点，提供常用分辨率快速选择
- 更新分辨率预设节点，添加更多预设选项
- 改进保存文本节点，增加换行追加选项
- 更新依赖项，添加火山引擎SDK和soundfile等库
- 修复若干问题并优化现有节点功能
