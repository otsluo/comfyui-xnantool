...
特性：同样的节点，功能更丰富，更优化，bug少，更稳定。
备注：一些很基础的节点，就不会制作了，还是用原来的节点，如果粉丝需求多，我再去制作。

## 特别说明
版本在0.7.0，更新了大量的节点，和优化的节点，如果遇到节点报红色错误，请先尝试新建节点 ，因为这是版本更新导致的。
...
### 📏 预设管理类节点
预设管理类节点提供了丰富的预设管理功能，包括尺寸预设、比例预设、提示词预设、随机提示词生成等，帮助用户快速选择常用参数，提高工作效率。

有关预设管理类节点的详细信息，请参阅 [预设管理功能说明](README_preset_manager.md)。
...
## ⚠️ 注意事项
如果发现节点报红色错误，请先尝试新建节点 ，因为这是版本更新导致的。
...
- **更新日期**: 2026年4月29日
- **更新日志**:
feat(封面文字生成器): 添加透明底文字图片生成功能
实现封面文字生成器节点，支持文字位置选择、角度微调、字体选择和描边效果。包含中文显示名称和详细参数配置，可生成带透明背景的文字图片
