...
- **更新日期**: 2026年2月5日
- **更新日志**:
  - 新增视频转MP4节点支持多种编码参数配置。优化多个节点的显示名称和描述文本，移除冗余的"节点"后缀。修复保存图片节点的空文件名处理问题，完善Markdown转Excel节点的输出路径逻辑。更新相关文档说明新增功能和参数优化细节。
  - 重构初始化文件移除开发工具节点引用，清理代码注释。统一多个GIF处理节点的参数描述文本，优化图像格式转换节点的PNG优化选项说明。更新多语言配置文件以匹配新增功能和参数变更。
